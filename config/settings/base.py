...
)  # (viettel_shake/config/settings/base.py - 3 = viettel_shake/)
APPS_DIR = ROOT_DIR.path("viettel_shake")
...
MIGRATION_MODULES = {"sites": "viettel_shake.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "viettel_shake.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Dinh Anh Vu""", "anhvd27@gmail.com")]
